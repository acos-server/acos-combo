(function ($) {
  ...
  JSVEE.ui = function (id, area, settings) {
    ...
    var defaultSettings = { 'code' : 'top', 'console' : true, 'controls' : true, 'stackHeight' : 100,
      'rightPanelsWidth' : 150, 'heapHeight' : 80, 'width' : 850, 'codeWidth' : 'auto', 'classesLeft' : false,
      'consoleBelowHeap' : false, 'consoleLeft' : false };
