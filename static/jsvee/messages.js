(function($) {
  ...
  JSVEE.messages.failedText = function () {
	...
	JSVEE.messages.referenceTitle = function(id) {
		return 'A reference to an object, which is in the memory at location {0}'
				.format(id);
	};
	...
	JSVEE.messages.addReference = function(id) {
		return 'Fetching a reference to an object, which is in the memory at location {0}'
				.format(id);
	};
