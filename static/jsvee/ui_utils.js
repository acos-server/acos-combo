(function ($) {
  ...
  JSVEE.utils.ui.resizeStack = function (area) {
    ...
    var codeArea = area.find('.jsvee-code-area'), stackHeight = 0;
    ...
    if (codeArea.hasClass('jsvee-code-left')
        && codeArea.outerHeight(true) > area.find('.jsvee-memory-area').outerHeight(true)) {
  ...
  JSVEE.utils.ui.drawArrow = function (area, element1, element2) {
    ...
    var arrow = '<svg pointer-events="none" class="jsvee-ref-arrow" width="'
        + width
        + '" height="'
        + height
        + '" version="1.1" xmlns="http://www.w3.org/2000/svg" style="position: absolute; top: 0; left: 0;"><defs><marker id="arrow" viewBox="0 0 10 10" refX="10" refY="5" markerUnits="strokeWidth" markerWidth="4" markerHeight="4" orient="auto"><path stroke="#2756A3" fill="#2756A3" d="M 0 0 L 10 5 L 0 10 z"/></marker></defs>'
        + '<path d="M ' + best[0][0] + ' ' + best[0][1] + ' L ' + best[1][0] + ' ' + best[1][1] + '" '
        + '" fill="none" stroke="#2756A3" stroke-width="1.5" marker-end="url(#arrow)"/></svg>';
