(function($, _) { // wrap in anonymous function to not show some helper variables
   ...
   var translations = {
       ...
       trash_label: 'Vedä rivit ohjelmaasi tästä',
  ...
  VariableCheckGrader.prototype._python_exec = function(code) {
      ...
      // hack for Python 3 print() -> Python 2 print
      var modifiedCode = code.replace(/^(\s*)print\((.*)\)$/mg, '$1print $2').trim();
      ...
      return {mainmod: Sk.importMainWithBody("<stdin>", false, modifiedCode), output: output};
  };
